<div class="container-fluid">
  <div class="card">
    ...
    <div class="card-body table-responsive">
        <div id="CD" class="dataTables_wrapper dt-bootstrap4">
            <div class="col-sm-12 col-md-6">
                <div class="dt-buttons btn-group flex-wrap">               
                    <button class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="TD" type="button">
                        <span>Copy</span>
                    </button> 
                    <button class="btn btn-secondary buttons-csv buttons-html5" tabindex="0" aria-controls="TD" type="button">
                        <span>CSV</span>
                    </button> <button class="btn btn-secondary buttons-excel buttons-html5" tabindex="0" aria-controls="TD" type="button">
                        <span>Excel</span>
                    </button> <button class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="TD" type="button">
                        <span>PDF</span>
                    </button>
                </div>
            </div>
            <table id="DT" class="table table-hover table-bordered table-sm shadow">
                ...
                <tbody>
                <?php $a=1; foreach ($dataTab_doc as $key) : ?>
                    <tr>
                    <td><?= $a++ ?></td>
                    <!-- <td><?= $key->doce_id ?></td> -->
